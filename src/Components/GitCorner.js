export default function GitCorner() {
    return (
       ...
       idea from => https://github.com/tusharnankani/
   -->     */
        <div className="demo version-section"><a href="https://github.com/404diaby/react-todo-list-app" className="github-corner">
